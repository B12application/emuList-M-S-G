      ...
      <div className="w-full flex flex-col lg:flex-row min-h-screen relative z-10 pt-20 lg:pt-0">
          ...
          <div className="w-full max-w-md mx-auto space-y-5">
            ...
            <form onSubmit={handleSignup} className="space-y-3.5 pt-1">
              ...
              <button
                ...
                className="w-full py-2.5 bg-white dark:bg-zinc-900 hover:bg-slate-50 dark:hover:bg-zinc-800 border border-slate-200 dark:border-zinc-800 text-slate-800 dark:text-zinc-200 font-bold text-xs rounded-xl transition-all active:scale-[0.98] flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 shadow-2xs"
              >
        ...
        >
          ...
          <div className="pt-4 border-t border-slate-200/80 dark:border-zinc-800/80 flex flex-col sm:flex-row items-center justify-between gap-2 text-[11px] text-slate-500 dark:text-zinc-400 font-mono relative z-10">
            ...
            <span>B12 // PRIVACY FIRST OS &bull; MUSTAFA ULUSOY (EMU)</span>
          </div>
