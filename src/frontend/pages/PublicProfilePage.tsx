...
export default function PublicProfilePage() {
        ...
        return (
            <div className="min-h-screen pt-24 pb-16 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-stone-500 dark:text-zinc-400">{t('common.loading')}</p>
                </div>
            </div>
        );
    }
    ...
    if (!profile) {
        return (
            <div className="min-h-screen pt-24 pb-16 flex items-center justify-center">
                <div className="text-center">
                    <FaUser className="h-16 w-16 text-gray-300 dark:text-stone-700 mx-auto mb-4" />
        ...
        <div className="min-h-screen pt-24 pb-16">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <button
                    ...
                    className="mb-6 flex items-center gap-2 text-stone-600 dark:text-zinc-400 hover:text-rose-600 dark:hover:text-rose-400 transition-colors"
                >
                ...
                <motion.div
                    ...
                    className="bg-white dark:bg-zinc-800 rounded-2xl shadow-lg border border-stone-200 dark:border-zinc-700 p-8 mb-8"
                >
                    <div className="flex items-center gap-6">
                        <img
                            src={profile.photoURL || getDefaultAvatar(profile.gender)}
                            alt={profile.displayName}
                            className="w-24 h-24 rounded-full object-cover shadow-lg border-4 border-white dark:border-zinc-700"
                        />
                        ...
                        <div className="flex items-center gap-3 mt-4">
                            {profile.socialLinks.github && (
                                <a
                                    ...
                                    className="w-9 h-9 rounded-full bg-stone-200 dark:bg-zinc-700 flex items-center justify-center text-stone-700 dark:text-zinc-300 hover:bg-gray-800 hover:text-white dark:hover:bg-stone-200 dark:hover:text-stone-800 transition-all hover:scale-110"
                                    title="GitHub"
                                >
                                    <FaGithub size={16} />
                                </a>
                            ...
                            {profile.socialLinks.linkedin && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-9 h-9 rounded-full bg-stone-200 dark:bg-zinc-700 flex items-center justify-center text-blue-600 hover:bg-blue-600 hover:text-white transition-all hover:scale-110"
                                    title="LinkedIn"
                                >
                                    <FaLinkedin size={16} />
                                </a>
                            ...
                            {profile.socialLinks.twitter && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-9 h-9 rounded-full bg-stone-200 dark:bg-zinc-700 flex items-center justify-center text-sky-500 hover:bg-sky-500 hover:text-white transition-all hover:scale-110"
                                    title="Twitter"
                                >
                                    <FaTwitter size={16} />
                                </a>
                            ...
                            {profile.socialLinks.instagram && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-9 h-9 rounded-full bg-stone-200 dark:bg-zinc-700 flex items-center justify-center text-pink-500 hover:bg-gradient-to-br hover:from-pink-500 hover:to-orange-400 hover:text-white transition-all hover:scale-110"
                                    title="Instagram"
                                >
                                    <FaInstagram size={16} />
                                </a>
                            ...
                            {profile.socialLinks.website && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-9 h-9 rounded-full bg-stone-200 dark:bg-zinc-700 flex items-center justify-center text-emerald-500 hover:bg-emerald-500 hover:text-white transition-all hover:scale-110"
                                    title="Website"
                                >
                                    <FaGlobe size={16} />
                                </a>
                    ...
                    {stats && (
                        <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-4">
                            <div className="text-center p-3 bg-stone-100 dark:bg-zinc-700/50 rounded-xl">
                                <p className="text-2xl font-bold text-stone-900 dark:text-white">{stats.totalCount}</p>
                                <p className="text-xs text-stone-500 dark:text-zinc-400">{t('home.totalItems')}</p>
                            </div>
                            <div className="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                                <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{stats.movieCount}</p>
                                <p className="text-xs text-stone-500 dark:text-zinc-400">{t('nav.movies')}</p>
                            </div>
                            <div className="text-center p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl">
                                <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">{stats.seriesCount}</p>
                                <p className="text-xs text-stone-500 dark:text-zinc-400">{t('nav.series')}</p>
                            </div>
                            <div className="text-center p-3 bg-amber-50 dark:bg-amber-900/20 rounded-xl">
                                <p className="text-2xl font-bold text-amber-600 dark:text-amber-400">{stats.gameCount}</p>
                                <p className="text-xs text-stone-500 dark:text-zinc-400">{t('nav.games')}</p>
                            </div>
                        </div>
                    )}
                </motion.div>
                ...
                <div className="bg-white dark:bg-zinc-800 rounded-2xl shadow-lg border border-stone-200 dark:border-zinc-700 overflow-hidden">
                    ...
                    <div className="sticky top-0 z-10 bg-gradient-to-r from-white to-gray-50 dark:from-zinc-800 dark:to-zinc-900 border-b border-stone-300 dark:border-zinc-700 backdrop-blur-sm bg-white/95 dark:bg-zinc-800/95">
                        ...
                        <div className="px-6 pb-4">
                            <div className="flex items-center gap-1 bg-stone-200 dark:bg-zinc-900/50 p-1 rounded-xl">
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg font-semibold text-sm transition-all duration-200 ${selectedType === 'all'
                                        ? 'bg-white dark:bg-zinc-700 text-rose-600 dark:text-amber-400 shadow-md'
                        ...
                        <div className="px-6 pb-4">
                            <div className="flex flex-wrap items-center gap-2">
                                <span className="text-xs font-medium text-stone-500 dark:text-zinc-400 mr-1">
                                    Filtre:
                                </span>
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-all ${selectedFilter === 'all'
                                        ...
                                        : 'bg-gray-100 dark:bg-zinc-700 text-stone-600 dark:text-zinc-400 hover:bg-stone-200 dark:hover:bg-gray-600'
                                        }`}
                                >
                                    {t('list.all')}
                                </button>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                                {mediaItems.map(item => (
                                    <motion.div
                                        ...
                                        className="group cursor-pointer bg-stone-100 dark:bg-zinc-700/50 rounded-xl overflow-hidden hover:shadow-xl transition-all hover:-translate-y-1"
                                    >
                                        <div className="relative aspect-[2/3] bg-stone-200 dark:bg-zinc-700">
                                            {item.image ? (
                                                <img
                                                    src={item.image}
                                                    alt={item.title}
                                        ...
                                        <div className="p-3">
                                            ...
                                            <div className="flex items-center justify-between text-xs gap-2">
                                                ...
                                                <span className={`px-2 py-1 rounded-full font-semibold ${item.watched
                                                    ...
                                                    : 'bg-gray-200 dark:bg-zinc-600 text-stone-700 dark:text-zinc-300'
                                                    }`}>
                                                    {item.watched
                                                        ? '✓ ' + (item.type === 'book' ? t('media.readByUser') : item.type === 'game' ? t('media.playedByUser') : t('media.watchedByUser'))
