...
export const translationsTR = {
    ...
    vault: {
        ...
        cronScheduleTitle: 'Proje İçi Otomatik Cron Job Takvimi',
        dailyMediaJob: 'Günlük Medya Job\'u',
        dailyMediaJobDesc: 'GitHub Actions projede /backups/media/ altına her gece JSON ve TXT kaydeder.',
        monthlyExpensesJob: 'Aylık Harcama Job\'u',
        monthlyExpensesJobDesc: 'Her ayın 15\'inde /backups/expenses/ altına tam bütçe yedeğini işler.',
